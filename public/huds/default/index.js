...
const COLOR_NEW_TRANS_CT = "rgba(70, 232, 41, 0.88)";
const COLOR_NEW_TRANS_T = "rgba(121, 43, 237, 0.88)";
...
const COLOR_LIGHT = "rgba(172, 172, 172, 1)";
const COLOR_DARK = "rgba(19, 19, 19, 1)";
const COLOR_WHITE_DULL = "rgba(250, 250, 250, 0.25)";
const HEALTH_BAR_COLOR = "rgba(172, 172, 172, 1)";
    ...
    if (matchup && matchup.toLowerCase() != "none") {
        if (matchup == "bo1") {
            $("#left_team .block2")
                ...
                .css("border-color", match.team_1.map_score >= 1 ? COLOR_WHITE : "");
            $("#right_team .block2")
                .css("opacity", "1")
                .css("background-color", match.team_2.map_score >= 1 ? COLOR_WHITE : "")
                .css("border-color", match.team_2.map_score >= 1 ? COLOR_WHITE : "");
        } else if (matchup == "bo3") {
            $("#left_team .block4")
                .css("opacity", "1")
                .css("background-color", match.team_1.map_score >= 1 ? COLOR_WHITE : "")
            ...
            $("#left_team .block5")
                ...
                .css("border-color", match.team_1.map_score >= 2 ? COLOR_WHITE : "");
            $("#right_team .block4")
                .css("opacity", "1")
                .css("background-color", match.team_2.map_score >= 1 ? COLOR_WHITE : "")
                .css("border-color", match.team_2.map_score >= 1 ? COLOR_WHITE : "");
            $("#right_team .block5")
                ...
                .css("border-color", match.team_2.map_score >= 2 ? COLOR_WHITE : "");
        } else if (matchup == "bo5") {
            $("#left_team .block1")
                .css("opacity", "1")
                .css("background-color", match.team_1.map_score >= 1 ? COLOR_WHITE : "")
            ...
            $("#left_team .block3")
                ...
                .css("border-color", match.team_1.map_score >= 3 ? COLOR_WHITE : "");
            $("#right_team .block1")
                .css("opacity", "1")
                .css("background-color", match.team_2.map_score >= 1 ? COLOR_WHITE : "")
                .css("border-color", match.team_2.map_score >= 1 ? COLOR_WHITE : "");
            ...
            $("#right_team .block3")
                ...
                .css("border-color", match.team_2.map_score >= 3 ? COLOR_WHITE : "");
        }
    }
}
...
function fillObserved(obs) {
    ...
    $("#obs_lane3").css("background-color", team_color_trans);
...
function fillPlayer(player, nr, side, observed, phase, previously) {
    ...
    $bottom.find("#player_current_money_text").css("color", dead ? COLOR_WHITE : COLOR_WHITE/*"#a7d32e"*/);
